...
class SemanticSegmentationDatasetFormat(AbstractDatasetFormat):
    ...
    def postprocess(self, errors:List[str], output_dir:str, temp_yaml_path:str, split_name:str, tmp_path:str, id2label_path:str, storage_type: str):
    ...
    def validate(self, storage_type:str = "s3", **kwargs):
        ...
        zip_file_path, md5_hash, succeed = self.postprocess(errors, output_dir, temp_yaml_path, split_name, tmp_path, id2label_path, storage_type)
